...
class Conditions implements \Magento\Framework\Data\OptionSourceInterface
{
    ...
    /**
     * @var \Softnoesis\Rma\Model\Conditions
     */
    public $conditions;
     ...
     */
    public function __construct(\Softnoesis\Rma\Model\ConditionsFactory $conditionsFactory)
    {
    ...
    {
        $options[] = ['label' => '', 'value' => ''];
        $availableOptions = $this->conditionsFactory->create()->getCollection();
        foreach ($availableOptions as $option) {
            $options[] = [
                'label' => $option->getTitle(),
                'value' => $option->getConditionsId(),
            ];
        }
