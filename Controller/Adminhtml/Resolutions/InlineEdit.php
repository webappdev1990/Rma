...
class InlineEdit extends ResolutionsController
{
    /**
     * @var JsonFactory
     */
    ...
    public function __construct(
        ...
        parent::__construct($registry, $resolutionsFactory, $context);
    }
    /**
    ...
    {
        return '[ Resolution ID: ' . $status->getId() . '] ' . $errorText;
    }
    ...
    {
        return $this->resolutionsFactory->create()->load($statusId);
    }
}
